...
The [C++ implementation](cpp/pianolizer.hpp) should compile just fine on any platform that supports C++17, there are no dependencies as the code uses C++17 standard data types.
